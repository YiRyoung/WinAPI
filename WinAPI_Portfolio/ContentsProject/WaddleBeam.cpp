...
void AWaddleBeam::Phase01(float _Delta)
{
...
void AWaddleBeam::Phase02(float _Delta)
{
...
void AWaddleBeam::Phase03(float _Delta)
{
...
void AWaddleBeam::Phase04(float _Delta)
{
...
void AWaddleBeam::Phase05(float _Delta)
{
...
void AWaddleBeam::Phase06(float _Delta)
{
	Destroy();
}